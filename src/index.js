...
/**
 * @typedef {Object} CustomDeadLetteringOptions Custom Dead-letter-queue options
 * @property {Boolean} enabled Enable dead-letter-queue
 * @property {Function} function Enable dead-letter-queue
 */
...
module.exports = function ChannelsCrawlyfiMiddleware(mwOpts) {
	mwOpts = _.defaultsDeep({}, mwOpts, {
		adapter: null,
		schemaProperty: "channels",
		sendMethodName: "sendToChannel",
